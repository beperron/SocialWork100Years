...
Exclude incorrectly captured articles. 
```{r}
...
dim(filter(full.df, attributes == "pubYear"))
dim(filter(full.df, attributes == "article"))
dim(filter(full.df, attributes == "journal"))
