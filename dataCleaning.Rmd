---
title: "Examining a Quarter Century of Publishing Trends in Social Work Research: A Data Science Perspective"
author: 
output: pdf_document
---
...
```{r dataCleaning, comment=NA, echo=FALSE, eval=FALSE}
appendData.f()
shortArticles.f()
titleMatching.f()
otherDocuments.f()
