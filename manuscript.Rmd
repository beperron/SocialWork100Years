...
proquest_summary.df <- read.csv("./Data/proquest_summary.csv")
...
library(lubridate)
head(proquest_summary.df)
pq_summary <- proquest_summary.df

pq_summaryas.character(pq_summary$Citation.First)
  
  
  ifelse(proquest_summary.df$Citation.First == "Current", "9/19/15", proquest_summary.df$Citation.First)

proquest_summary.df$Citation.Last <- ifelse(proquest_summary.df$Abstract.Last == "Current", "9/19/15", proquest_summary.df$Citation.Last)
