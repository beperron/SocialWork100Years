...
uncited.forecast <-data.frame(forecast(fit, 2))
...
#articles.df.melted <- rbind(articles.df.melted, uncited.df)


cp <- c("#fdb864", "#e66101", "#b2abd2", "#5e3c99" )

ggplot(na.omit(articles.df.melted),  aes(Year, value, colour = variable)) + 
    geom_line() + 
    geom_point() + 
    scale_color_manual(values=cp) + 
    geom_point(data = uncited.df, aes(Year, value, colour = variable)) + 
    ylim(c(0, 2700))
