...
df.96.10$HD.N <- ifelse(is.na(df.96.10$HD.N), df.96.10$scopus.N, df.96.10$HD.N)
...
uncited.melted <- reshape2::melt(uncited.df[,c("Year", "Published", "Uncited")], id.vars = "Year")
...
ggplot(observed.df.melted, aes(Year, value, colour = variable)) + 
    geom_line(alpha = .60) + 
    geom_point(size =4) +
