...
it is relatively new and has
become part of social work terminology,  



 that are common to the framework of
evidence-based practices (EBP).  This topic area was selected because it is a
more recent area of research relative to other social work topics (e.g., child
welfare and case management).  


The final part of the study involved a topical analysis by using regular
expressions to identify articles using keywords based on different levels of
evidence.  We specified four sets of keywords relating to meta-analysis,
systematic reviews, randomized controlled trials, and quasi-experimental
studies.  We refer to these as _sets_ of keywords because we used a number of
different variations on the spelling and related terminology.  For example, RCT
involved a search specification that such as "randomized control trial,"
"randomized controlled trial," and "RCT".  The complete definitions of these
are provided in the index.  

Figure 4 is a stacked line chart showing the number of each type of article
throughout the study timeframe.  This figure shows increased numbers of all
study types.  It is important to consider this growth relative to the overall
growth of the field of social work.  Thus, in Figure 5, we plotted the
proportion of each keyword class relative to the overall number of articles for
that given year.  This shows an increase -- albeit a small increase -- in the
proportion of journals, providing evidence of growth relative to the overall
field.  Slightly more than 1% of all articles published contained a phrase
equivalent to randomized control trial.   
