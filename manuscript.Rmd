...
proQuestBWR.df <- proQuestBWR.f(csv=FALSE, path=path)
...
ebscoBWR.df <- ebscoBWR.f(csv=FALSE, path=path)
...
source("/Users/beperron/Git/SocialWorkResearch/functions/requireAuthorJournalTitleYear.R")
