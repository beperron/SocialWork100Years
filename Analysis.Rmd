...
ebJournals.df.unique <- ebJournals.df %>% select(ISSN)
ebJournals.df.unique <- !duplicated(ebJournals.df.unique)
ebJournals.df <- ebJournals.df[ebJournals.df.unique, ]



ebJournals.df <- ebJournals.df[!(ebJournals.df$PublicationName %in% journals.unique),]    

ebJournals.df <- select(ebJournals.df, -PublicationName, -ISSN) %>%
    mutate(journalID = c(1:nrow(ebJournals.df))) %>%
